...
<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col w-full bg-white border-gray-200 rounded-lg sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700  min-h-full">
                    <form class="space-y-6" action="{{ route('addMaterial', ['course_code'=> $course->code, 'session'=> $session]) }}" method="POST" enctype="multipart/form-data">
                        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Upload Course Assignment</h5>
                        @csrf
                ...
                <div class="flex flex-col w-full bg-white border-gray-200 rounded-lg sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700  min-h-full">
                    <h5 class="text-xl mb-5 font-medium text-gray-900 dark:text-white">Previous Course Assignments</h5>
                    ...
                    <div class="p-6 mb-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        @if($assignment -> file)
                        <a href="{{ route('downloadAssignment', $assignment->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Download Assignment
                                    ...
                                    <div class="p-6 space-y-6">
                                        <form action="{{ route('editAssignment', $assignment->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="relative w-full">                            
                                                ...
                                                <input id="deadline" name="deadline" datepicker datepicker-buttons datepicker-autoselect-today type="text" value="{{ $assignment->deadline }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                            </div>    
